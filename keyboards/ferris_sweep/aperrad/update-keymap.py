...
annotation_keycodes = { # keycodes with annotations
    "layer": {"keycodes": ["LA_SYM", "LA_SYM2", "LA_EXT", "LA_FUN"],
              "label": "layer"},
    "one-shot": {"keycodes": ["OS_SFT", "OS_CTL", "OS_ALT", "OS_CMD", "OSM_MEH"],
                 "label": "one-shot"},
...
layer_names = {
  "CLM": "Base",
  "SYM": "Symbols &amp; Numpad",
  "SYM2": "Alt Symbols &amp; Mouse",
  "EXT": "Navigation &amp; Shortcuts",
  "FUN" : "Fn keys &amp; Media"
}
...
keycode_prefix = "KC_"
key_names = {
    "SHFT_BSPC": {"label": "&#8679;/&#9003;", "title": ""},
    "KC_LSFT": {"label": "&#8679;", "title": ""},
    "OS_SFT": {"label": "&#8679;", "title": "Shift"},
    "OS_CTL": {"label": "&#94;", "title": "Control"},
    "OS_ALT": {"label": "&#8997;", "title": "Option"},
    "OS_CMD": {"label": "&#8984;", "title": "Command"},
    "OSM_MEH": {"label": "&#94;&#8997;&#8679;", "title": "Globe"},

    "LA_FUN": {"label": "Func", "title": ""},
    "LA_EXT": {"label": "Ext", "title": ""},
    "LA_SYM": {"label": "Sym", "title": ""},
    "LA_SYM2": {"label": "Alt Sym", "title": ""},
    ...
    "KC_MSTP": {"label": "&#x23F9;", "title": "Next Track"},
    ...
    "PRINT": {"label": "&#x1F4F8;", "title": ""},
    "KC_WFWD": {"label": "Browser &#x23EE;", "title": ""},
    "KC_WBAK": {"label": "Browser &#x23ED;", "title": ""},
    ...
    "KC_WH_U": {"label": "WH &#9650;", "title": ""},
    "KC_WH_L": {"label": "WH &#9664;", "title": ""},
    "KC_WH_D": {"label": "WH &#9660;", "title": ""},
    "KC_WH_R": {"label": "WH &#9654;", "title": ""},

    "KC_MS_U": {"label": "M &#9650;", "title": ""},
    "KC_MS_L": {"label": "M &#9664;", "title": ""},
    "KC_MS_D": {"label": "M &#9660;", "title": ""},
    "KC_MS_R": {"label": "M &#9654;", "title": ""},
    "KC_BTN1": {"label": "L Click", "title": ""},
    "KC_BTN2": {"label": "R Click", "title": ""},
    "KC_BTN3": {"label": "M &#x23EE;", "title": ""},
    "KC_BTN4": {"label": "M &#x23ED;", "title": ""},

    "KC_UNDO": {"label": "Undo", "title": "Undo"},
    "KC_CUT": {"label": "Cut", "title": "Cut"},
    "KC_COPY": {"label": "Copy", "title": ""},
    "KC_PSTE": {"label": "Paste", "title": ""},
...
def svg_for_layer(layer_id, start_y, show_title):
    print("svg_for_layer(" + layer_id + "," + str(start_y) + "," + str(show_title) + ")")
    svg_raw = ""
    cur_y = start_y
    row_num = 0
    col_num = 0
